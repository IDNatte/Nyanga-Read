...
<div
	...
	class="error-page flex justify-center items-center w-full h-screen flex-col"
>
	...
	>
		<div class="w-full border-b border-slate-500 px-5 py-2 italic font-thin capitalize">
			stacktrace
		</div>
		<div class="p-4">
